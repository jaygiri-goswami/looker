view: payment_receipts {
  sql_table_name: spacebasic.payment_receipts ;;
  drill_fields: [id]
  ...
  dimension: is_wallet_transaction {
    type: number
    sql: ${TABLE}.is_walletTransaction ;;
  }
  dimension: message {
    type: string
    sql: ${TABLE}.message ;;
  ...
  dimension: razorpay_remarks {
    type: string
    sql: ${TABLE}.razorpay_remarks ;;
  }
